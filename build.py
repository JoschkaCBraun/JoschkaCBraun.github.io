...
def get_personal_data() -> Tuple[List[str], str, str, str]:
    ...
    bio_text = f"""
                <p>
                    I am an AI Safety researcher focused on understanding and mitigating risks from advanced AI systems.
                </p>
                <p>
                    Currently, I’m a scholar in the <a href="https://www.matsprogram.org/" target="_blank">MATS Research Program</a>, working with
                    ...
                    <a href="https://scholar.google.com/citations?user=LoT0z6oAAAAJ&hl=en" target="_blank">Scott Emmons</a>. My current research investigates whether large language models can influence the training outcome of reinforcement learning by strategically altering their exploration behaviour.
                </p>
                <p>
                    Previously, I studied the reliability of steering vectors in Large Language Models with <a href="https://krasheninnikov.github.io/about/" target="_blank">Dmitrii Krasheninnikov</a> and <a href="https://scholar.google.ca/citations?user=5Uz70IoAAAAJ&hl=en" target="_blank">David Krueger</a> at the <a href="https://www.kasl.ai/" target="_blank">Krueger AI Safety Lab</a> at the University of Cambridge, and worked on representation engineering applications at the <a href="https://health-nlp.com/" target="_blank">Health-NLP</a> group with
                ...
                <p>
                    Beyond research, I am passionate about public debate and democratic discourse to shape informed perspectives on effective AI governance and policy. I’m a two-time German Debating Champion and have debated AI regulation with policymakers.
                </p>
                <p>
                    I hold a Master’s degree in Machine Learning and a Bachelor’s degree in Computer Science from the <a href="https://uni-tuebingen.de/" target="_blank">University of Tübingen</a>.
                </p>
                <p>
...
def get_author_dict() -> Dict[str, str]:
    ...
    return {
        ...
        "Eyon Jang": "https://scholar.google.com/citations?user=jXfklAEAAAAJ",
        ...
        "Nathalie Kirch": "https://scholar.google.com/citations?user=pSMaHaAAAAAJ",
        "Achu Menon": "https://achyutha11.github.io/",
        "Perusha Moodley": "https://scholar.google.com/citations?user=gGLCnwMAAAAJ",
    }
